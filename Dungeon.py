...
class dragon_lair(Scene):
    ...
    def enter(self):
        print "%s, you have entered into the dragon's lair." %(username)
...
class water_well(Scene):
    ...
    def enter(self):
        print "%s, you are now in a room with the watering well for the dungeon." %(username)
...
class level_2(Scene):
    ...
    def enter(self):
        ...
        print "This has lead you to the lower level of the dungeon."
        print "As you enter the room you notice two ogres."
        print "There is one in front of each door blocking your passage."
        print "What do you do?"
...
class torture_chamber(Scene):
    ...
    def enter(self):
        print "%s, it looks as if you have entered into the torture chamber." %(username)
...
class prison_cells(Scene):
    ...
    def enter(self):
        print "%s, you have stumbled upon a room in the dungeon that looks to have held prisoners." %(username)
        print "As you look around the room you see a door to the east"
        raw_input("> ")
